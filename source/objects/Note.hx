...
class Note extends FlxSprite {
	...
	public static var defaultNoteSkin(default, never):String = 'note/noteSkins/NOTE_assets';
		...
		if (noteData > -1 && noteType != value) {
			switch (value) {
				case 'Hurt Note':
					...
					noteSplashData.texture = 'note/noteSplashes/noteSplashes-electric';

					// gameplay data
					lowPriority = true;
					missHealth = isSustainNote ? 0.25 : 0.1;
					hitCausesMiss = true;
					hitsound = 'menu/cancelMenu';
