...
class VisualsUISubState extends BaseOptionsMenu {
	...
	public function new() {
		...
		var noteSkins:Array<String> = Mods.mergeAllTextsNamed('images/note/noteSkins/list.txt');
		...
		var noteSplashes:Array<String> = Mods.mergeAllTextsNamed('images/note/noteSplashes/list.txt');
		...
		var option:Option = new Option('Combo Location: ', "Where should the Combo be located at?", 'comboDisplay', 'string',
			['Screen', 'Info Bar', 'Disabled']);
		addOption(option);

		var option:Option = new Option('Show Judgements', 'Uncheck this if you don\'t want the judgments (Sick, Good, etc) to show up.', 'showRating', 'bool');
		addOption(option);
