...
class ModsMenuState extends MusicBeatState {
	...
	override function create() {
		...
		var button = new MenuButton(buttonsX, buttonsY, 80, 80, Paths.image('mods/modsMenuButtons'), function() moveModToPosition(0), 54,
			54); // Move to the top
		...
		var button = new MenuButton(buttonsX + 100, buttonsY, 80, 80, Paths.image('mods/modsMenuButtons'), function() moveModToPosition(curSelectedMod - 1),
			54, 54); // Move up
		...
		var button = new MenuButton(buttonsX + 200, buttonsY, 80, 80, Paths.image('mods/modsMenuButtons'), function() moveModToPosition(curSelectedMod + 1),
			54, 54); // Move down
		...
		settingsButton = new MenuButton(buttonsX + 300, buttonsY, 80, 80, Paths.image('mods/modsMenuButtons'), function() // Settings
		{
		...
		var button = new MenuButton(buttonsX + 400, buttonsY, 80, 80, Paths.image('mods/modsMenuButtons'), function() // On/Off
		{
			var curMod:ModItem = modsGroup.members[curSelectedMod];
...
class ModItem extends FlxSpriteGroup {
	...
	public var folder:String = 'mods/unknownMod';
	...
	public function new(folder:String) {
		...
		if (bmp != null) {
			...
			icon.loadGraphic(Paths.image('mods/unknownMod'), true, 150, 150);
