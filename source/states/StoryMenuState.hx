...
class StoryMenuState extends MusicBeatState {
	...
	override function create() {
		...
		for (i in 0...WeekData.weeksList.length) {
			...
			if (!isLocked || !weekFile.hiddenUntilUnlocked) {
				...
				var weekThing:MenuItem = new MenuItem(0, bgSprite.y + 396, "weekNumbers/" + WeekData.weeksList[i]);
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 425).loadGraphic(Paths.image('storymenu/Menu_Tracks'));
	...
	function changeDifficulty(change:Int = 0):Void {
		...
		var newImage:FlxGraphic = Paths.image('storymenu/menudifficulties/' + Paths.formatToSongPath(diff));
